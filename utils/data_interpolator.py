...
class DataInterpolator:
    ...
    def interpolate_bounding_boxes(self, data):
        ...
        Args:
            data (list): List of dictionaries containing detection data
            
        Returns:
            list: Interpolated data with missing frames filled
        """
    ...
    def process_file(self, input_path, output_path):
        """
        Process input CSV file and write interpolated data to output file
